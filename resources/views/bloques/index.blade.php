...
<x-ito.list-page title="Bloques" subtitle="Grupos de ensayo por sede y año">
                ...
                <tr>
                    ...
                    <td>
                        <x-ito.actions :id="'bloque-'.$bloque->id">
                            ...
                            <li>
                                <form action="{{ route('bloques.destroy', $bloque) }}" method="POST" data-confirm="¿Eliminar bloque?">
                                    @csrf @method('DELETE')
    ...
    <x-slot:footer>
        <div class="ito-footer-meta">@if(method_exists($bloques, 'total'))
            {{ $bloques->total() }} registros
        @endif
        </div>
