...
<x-ito.form-step :index="0" title="Identidad" help="Sede, tipo, nombre y de quién es el ítem.">
    <div class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre', $item?->nombre) }}" placeholder="Ej: Repique 12&quot;, Parches 12&quot; Remo" required>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function sync() {
        ...
        wrap.style.display = propietario.value === 'alumno' ? '' : 'none';
    }
