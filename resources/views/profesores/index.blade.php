...
<x-ito.list-page title="Profesores" subtitle="Cuerpo docente y vínculos a bloques">
                ...
                <tr>
                    ...
                    <td>
                        <x-ito.actions :id="'prof-'.$profesor->id">
                            ...
                            <li>
                                <form action="{{ route('profesores.destroy', $profesor) }}" method="POST" data-confirm="¿Eliminar este profesor?">
                                    @csrf @method('DELETE')
    ...
    <x-slot:footer>
        <div class="ito-footer-meta">@if(method_exists($profesores, 'total'))
